...
//		private static int a;//cant be declared static unless is constant (final static)
		...
		private void printMe() {
			...
			System.out.println("Inner1 :" + InnerClassExample1.this.a + "---" + InnerClassExample1.this.b);// Inner1
		}
...
//		public final static void printMe2() {}//cant have even final static method 
	...
	public static void main(String[] args) {
		InnerClassExample1 classExample1 = new InnerClassExample1();
		InnerClassExample1.Inner1 inner1 = classExample1.new Inner1();

...
//		B b=(B)r1;//ClassCastException
	...
	static void test3() {
		CastingClasses castingClasses = new CastingClasses();
		Runner3 runner3 = (Runner3) castingClasses;// ClassCastException
		castingClasses = (CastingClasses) runner3;// ClassCastException
		System.out.println(castingClasses instanceof Runner3);// false //unrelated but does not show error as it is
		// having interface
		System.out.println(runner3 instanceof  CastingClasses);// false //unrelated but does not show error as it is
		// having interface

...
public class ComparableExample1 implements Comparable<ComparableExample1> {
	...
	public ComparableExample1(int id, String name) {
		super();
		this.id = id;
		this.name = name;
	}
	...
	public static void main(String[] args) {
		List<ComparableExample1> list = new ArrayList<ComparableExample1>();
		list.add(new ComparableExample1(2, "Ganesh"));
		list.add(new ComparableExample1(1, "Ashwini"));
